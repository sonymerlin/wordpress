    ...
    RadiosToSlider.prototype = {
        ...
        setSlider: function() {
            ...
            $inputs.each(function() {
                ...
                if ($this.prop('checked')) {
                    ...
                    if(radioId == "option2") {
                        $sliderbar.css('background', 'red');
                    } else if(radioId == "option3") {
                        $sliderbar.css('background', 'red');
                    } else if(radioId == "option4") {
                        $sliderbar.css('background', 'red');
                    } else if(radioId == "option5") {
                        $sliderbar.css('background', 'red');
                    } 
        ...
        addInteraction: function() {
            ...
            $levels.on('click', function() {
                    ...
                    if(btn_val == 1) {
                        $(this).addClass('slider-label-color1');
                    } else if (btn_val == 2) {
                        $(this).addClass('slider-label-color2');
                    } else if (btn_val == 3) {
                        $(this).addClass('slider-label-color3');
                    } else if (btn_val == 4) {
                        $(this).addClass('slider-label-color4');
                    } else if (btn_val == 5) {
                        $(this).addClass('slider-label-color5');
                    }


                    $(".urr-rating-value.urr-bad-ratings-color").text(btn_val+"");
                    $(".urr-rating-value.urr-good-ratings-color ").text(btn_val+"");
                ...
                slider.value = btn_val;
                $bearer.attr('data-value', btn_val);
        ...
        hover: function() {
            ...
            $levels.on('hover', function() {
                ...
                if(btn_val == 1) {
                    $('[data-value="1"]').attr("title", "Poor");
                } else if(btn_val == 2) {
                    $('[data-value="2"]').attr("title", "Not Good");
                } else if(btn_val == 3) {
                    $('[data-value="3"]').attr("title", "Average");
                }  else if(btn_val == 4) {
                    $('[data-value="4"]').attr("title", "Good");
                } else {
                    $('[data-value="5"]').attr("title", "Excellent");
                }
